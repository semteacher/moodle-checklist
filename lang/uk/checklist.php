...
$string['checklist:emailoncomplete'] = 'Отримувати email про завершення';
$string['checklist:emaildetails'] = 'Отримувати email при будь-якій зміні відміток в контрольноу списку';
...
$string['eventoscereportviewed'] = 'Переглянуто звут ОСКІ/ОСПІ';
$string['eventstudentchecksupdated'] = 'Студент оновив відмітки';
$string['eventteacherchecksupdated'] = 'Викладач оновив відмітки';
$string['eventteacheroscemarksupdated'] = 'Викладач оновив оцінки за ОСКІ/ОСПІ';
...
$string['oscemarkundecided'] = 'Ви ще не складали цей навик ОСКІ/ОСПІ';
...
$string['progress'] = 'Відмітки';

$string['putchecksforvisible'] = 'Всім показаним студентам:';//@TDMU-01 title for column select control
...
$string['togglecolumn'] = 'Відмітити: стовебць';

$string['toggledates'] = 'Показати/приховати автора і дату відмітки';
$string['togglerow'] = 'Відмітити: рядок';
...
$string['viewsinglereport'] = 'Переглянути відмітки цього користувача';
$string['viewsingleupdate'] = 'Оновити відмітки цього користувача';
