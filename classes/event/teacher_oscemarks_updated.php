...
/**
 * The mod_checklist teacher OSCE marks updated event.
 *
...
/**
 * The mod_checklist teacher OSCE marks updated class.
 *
 * @package    mod_checklist
 * @since      Moodle 2.7
 * @copyright  2014 Andriy Semenets <semteacher@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class teacher_oscemarks_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventteacheroscemarksupdated', 'mod_checklist');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated the teacher OSCE marks for user '$this->relateduserid' on the ".
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'checklist', 'update osce marks', 'oscereport.php?id='.$this->contextinstanceid.
