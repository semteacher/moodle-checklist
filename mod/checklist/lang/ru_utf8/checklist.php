...
$string['autoupdatewarning_both'] = 'Пункты этого контрольного списка будут обновлены автоматически (как только студенты выполнят соответственную деятельность). Однако, так как этот контрольный список является \'student and teacher\' индикатор выполнения будет обновлен когда преподаватель подтвердит указанные оценки.';
$string['autoupdatewarning_student'] = 'Пункты этого списка будут обновлены автоматически (как только студенты выполнят соответственную деятельность).';
$string['autoupdatewarning_teacher'] = 'Автоматическое обновление для даного контрольного списка включено, но эти отметки не будут показаны поскольку суейчас отбражаются лишь отметки \'teacher\'.';
...
$string['checklistdefaultname'] = 'Матрикул практичних навыков';
...
$string['checklist:updateown'] = 'Обновить вашы кконтрольные отметки';
...
$string['completiongradehelp'] = 'Заключительная оценка не является процентом';
$string['configallowmodulelinks'] = 'Разрешить связывать пункты контрольного спиcка с другими модулями (замедляет редактирование контрольного списка)';
...
$string['emailoncompletebody'] = 'Пользователь $a->user выполнил контрольный список \'$a->checklist\'
...
$string['import'] = 'Імпортировать пункты';
$string['importfile'] = 'Виберите файл для импорта';
...
$string['oscetoggledates'] = 'Показать/скрыть авторов и даты оценок за ОСКЭ/ОСПЭ';
...
$string['teachernoteditcheck'] = 'Студенты';
