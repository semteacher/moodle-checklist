...
$string['autoupdatewarning_both'] = 'Пункти цього контрольного списку будуть автоматично оновлені (щойно студенти завершать відповідну діяльність). Однак, оскільки цей контрольний список є \'student and teacher\' індикатор виконання буде оновлено коли викладач підтвердить дані оцінки.';
...
$string['autoupdatewarning_teacher'] = 'Автоматичне оновлення для даного контрольного списку увімкнене, але ці відмітки не будуть відображені оскільки зараз відображаються лише відмітки \'teacher\'.';
...
$string['teachernoteditcheck'] = 'Студенти';
